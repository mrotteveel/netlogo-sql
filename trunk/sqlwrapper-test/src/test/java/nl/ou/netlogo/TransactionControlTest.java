...
/**
 * Tests for transaction control statements: sql:start-transaction, sql:commit-transaction, sql:rollback-transaction.
 * 
 * @author Mark
 */
public class TransactionControlTest extends HeadlessTest {
	 ...
	 * <p>
	 * Expected: inserted row should be visible for other connection after commit.
	 * </p>
	 * 
	 * @throws Exception For any exceptions during testing
	 */
	 ...
	 * <p>
	 * Expected: inserted row should not be visible for other connection after commit.
	 * </p>
	 * 
	 * @throws Exception For any exceptions during testing
	 */
	 ...
	 * <p>
	 * Expected: changes to row not visible to other connection before commit, visible after commit. 
	 * </p>
	 * 
	 * @throws Exception For any exceptions during testing
	 */
	 ...
	 * <p>
	 * Expected: changes to row visible to own connection before rollback, changes reverted for own connection after rollback.
	 * </p>
	 * 
	 * @throws Exception For any exceptions during testing
	 */
	 ...
	 * <p>
	 * Expected: rollback-transaction will work if using sql:autocommit-off instead of sql:start-transaction, changes not visible after rollback.
	 * </p>
	 * 
	 * @throws Exception For any exceptions during testing
	 */
	...
	/**
	 * Test if using commit-transaction throws an exception if autocommit is enabled.
	 * <p>
	 * Expected: EngineException when calling sql:commit-transaction while in autocommit mode.
	 * </p>
	 * 
	 * @throws Exception For any exceptions during testing
	 */
	...
	/**
	 * Test if using rollback-transaction throws an exception if autocommit is enabled.
	 * <p>
	 * Expected: EngineException when calling sql:rollback-transaction while in autocommit mode.
	 * </p>
	 * 
	 * @throws Exception For any exceptions during testing
	 */
	...
	/**
	 * Test if sql:fetch-row does not disconnect while a transaction is active and autodisconnect is enabled.
	 * <p>
	...
	/**
	 * Test if sql:fetch-resultset does not disconnect while a transaction is active and autodisconnect is enabled.
	 * <p>
	...
	/**
	 * Test if an update statement (DELETE in this test) does not disconnect while a transaction is active and autodisconnect is enabled.
	 * <p>
	 * Expected: No autodisconnect after update statement (DELETE in this test) during a transaction.
	 * </p>
	 * 
	 * @throws Exception For any exceptions during testing
	 */
	...
	/**
	 * Test if sql:commit-transaction does disconnect with autodisconnect is enabled.
	 * <p>
	...
	/**
	 * Test if sql:rollback-transaction does disconnect with autodisconnect is enabled.
	 * <p>
	...
	/**
	 * Test if sql:autocommit-on does disconnect with autodisconnect is enabled and a transaction was active.
	 * <p>
