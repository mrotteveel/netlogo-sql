...
public class SqlResultSet {
	 ...
	 */
	protected SqlResultSet(ResultSet resultSet, AutodisconnectCoordinator autodisconnectCoordinator) throws ExtensionException {
		this.resultSet = resultSet;
		this.autodisconnectCoordinator = autodisconnectCoordinator;

		/*
		 * initial state of a resultset is before the first row, or
	...
	/**
	 * Method used to check if there is a next row available
	 * in the result set.
	 * @return true if so, false otherwise.
	 */
