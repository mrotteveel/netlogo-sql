...
public class CurrentDatabaseTest extends HeadlessTest {
	...
	/**
	 * Test if sql:current-database will return schema name used in the connect command.
	 * <p>
	 * Expected: returned schema name is equal to schema name used in connect.
	 * </p>
	 * <p>
	 * Assumption: schema name used in test has same casing as schema name on database.
	 * </p>
	 * 
	...
	/**
	 * Test if sql:current-database throws an error if no connection is established (and no pooling).
	 * <p>
	...
	/**
	 * Test if sql:current-database does not autodisconnect when connection created using sql:connect.
	 * <p>
	...
	/**
	 * Test if sql:current-database will return schema name used in the defaultconnection configuration.
	 * <p>
	 * Expected: returned schema name is equal to schema name used in defaultconnection configuration.
	 * </p>
	 * <p>
	 * Assumption: schema name used in test has same casing as schema name on database.
	 * </p>
	...
	/**
	 * Test if sql:current-database does not autodisconnect when connection created using connectionpool with autodisconnect disabled.
	 * <p>
	 * Expected: connection is not auto-disconnected after sql:current-database
	 * </p>
	 * 
	...
	/**
	 * Test if sql:current-database does autodisconnect when connection created from connectionpool when autodisconnect is
	 * enabled for the connection pool.
	 * 
	 * @throws Exception For any exceptions during testing
	 */
	@Test
